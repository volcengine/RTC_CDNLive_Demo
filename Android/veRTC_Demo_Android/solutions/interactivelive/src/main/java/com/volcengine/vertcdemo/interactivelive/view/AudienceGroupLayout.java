...
public class AudienceGroupLayout extends LinearLayout {
    ...
    public AudienceGroupLayout(Context context) {
        super(context);
        initView();
    }

    public AudienceGroupLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public AudienceGroupLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
