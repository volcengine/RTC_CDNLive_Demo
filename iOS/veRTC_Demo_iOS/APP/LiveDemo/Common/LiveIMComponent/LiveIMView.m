...
@interface LiveIMView () <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *roomTableView;

@end

@implementation LiveIMView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LiveIMCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LiveIMCellID" forIndexPath:indexPath];
...
- (UITableView *)roomTableView {
    if (!_roomTableView) {
        ...
        [_roomTableView registerClass:LiveIMCell.class forCellReuseIdentifier:@"LiveIMCellID"];
