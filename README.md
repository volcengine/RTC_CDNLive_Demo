...
互动直播是指主播创建自己的直播间，与其他主播进行连麦 PK，实现多个直播间之间的互动；同时主播也可以与直播间内的观众连麦，开启视频聊天室，与观众实时音视频互动。互动时，支持添加美颜特效，播放背景音乐。该方案中观众从 CDN 拉流。
...
场景详细介绍与技术实现详情，请参看[互动直播](https://www.volcengine.com/docs/6348/70025)。
